...
<source src="arcane.mp4" type="video/mp4">
</video>
<script src="bootstrap-5.1.3-dist/js/bootstrap.min.js"></script>
<div class="container">

       
<div class="mt-4 p-5 bg-pink text-black rounded">
  <h1>PERPUSTAKAAN</h1>
  <p>SELAMAT DATANG</p>
</div>
    <div>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="?page=anggota">Buku</a>
                </li>
        ...
        ?>
        <center><h5 style = "color: gray;" >@Dityourbae<center>
</body>
</html>
<?php
}
